  ...
  <section class="archive-panel">
    <div class="panel-header">
      ...
      <div class="header-actions">
        <span class="summary-badge">个体档案 {{ summary.individual_archive_count || 0 }} 份</span>
    ...
    <div class="archive-layout">
      <div class="archive-list">
        <button
          ...
          :key="archive.id"
          class="archive-card"
          :class="{ active: archive.id === selectedArchiveId, inactive: archive.is_active === false }"
...
.panel-header,.detail-header,.inline-actions,.archive-top,.animal-top,.animal-meta,.header-actions{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}
...
.helper-text{color:#8ea9af;font-size:13px}
...
.summary-grid,.form-grid,.animal-form-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}
